...
const METRIC_DEFS = [
  ...
  { key: 'stress', label: 'Stress', unit: '/100', tone: 'ink', unsupported: true },
  ...
  { key: 'ecg', label: 'ECG', unit: 'avg HR', tone: 'ink', unsupported: true },
  { key: 'bodyFat', label: 'Body fat', unit: '%', tone: 'ink', unsupported: true },
