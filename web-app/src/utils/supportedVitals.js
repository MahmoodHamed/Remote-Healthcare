...
export const SUPPORTED_METRIC_DEFS = [
  ...
  { key: 'skinTemperatureC', label: 'Skin temp. (wrist)', unit: '°C', tone: 'blue', digits: 1, source: 'sdk', desc: 'Samsung OBJECT_TEMPERATURE — wrist skin contact' },
  { key: 'ambientTemperatureC', label: 'Ambient temp. (room)', unit: '°C', tone: 'ink', digits: 1, source: 'sdk', desc: 'Samsung AMBIENT_TEMPERATURE — surrounding air' },
...
export const HISTORY_COLUMNS = [
  ...
  { key: 'skinTemperatureC', label: 'Skin °C (wrist)', digits: 1 },
  { key: 'ambientTemperatureC', label: 'Ambient °C (room)', digits: 1 },
